...
A web version showcasing the current state of the project can be found at: [https://matthewlai.ca/hex0ad](https://matthewlai.ca/hex0ad).

A [modern browser supporting WebGL 2](https://caniuse.com/webgl2) and WebAssembly is required (eg. modern Chrome, Firefox, Edge, or Safari).
